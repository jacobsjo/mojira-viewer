...
export class IssueFlair {
    ...
    public static IssueFlairs = {
        ...
        PrioLow: new IssueFlair('mojang-low','Low Priority'),
        PrioNormal: new IssueFlair('mojang-normal', 'Normal Priority'),
        PrioImportant: new IssueFlair('mojang-important', 'Important'),
        PrioVeryImportant: new IssueFlair('mojang-very-important', 'Very Important'),
